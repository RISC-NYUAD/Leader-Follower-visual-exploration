...
int main(int argc, char** argv)
{
	...
	geometry_msgs::PoseStampedConstPtr TV_Pos_sub= ros::topic::waitForMessage<geometry_msgs::PoseStamped>("/vrpn_client_node/mini8/pose", nh);
	...
	ROS_INFO("YAW offsets configured");
