...
void aruco3_init(){
	...
	for(int j=0; j<4 ; j++){
		...
		MarkerRT.rotate(MarkerRotation_vector2);
		//Final translate over new Z
		//Eigen::Vector3d MarkerTrans2(0, -SmalltileSize/2, 0.095571);
        ...
        //std::cout<< "MarkerRT small tile: " << MarkerRT(0,3) << " " << MarkerRT(1,3) << " " << MarkerRT(2,3) << " D: " << distSideToSolidCenter << std::endl;
	...
	//Update for actual values
	std::vector<double> v0 = {0.040319, 0.064036+actualRectSideSize/2, 0.061178 };
	std::vector<double> v1 = {0.061178, 0.064036+actualRectSideSize/2, 0.040319 };
	std::vector<double> v2 = {0.073221, 0.039949+actualRectSideSize/2, 0.052362 };
	std::vector<double> v3 = {0.052362, 0.039949+actualRectSideSize/2, 0.073221 };
    
    std::vector<double> v4 = {0.061178 , 0.064036+actualRectSideSize/2, -0.040319};
	std::vector<double> v5 = {0.040319, 0.064036+actualRectSideSize/2, -0.061178};
	std::vector<double> v6 = {0.052362, 0.039949+actualRectSideSize/2, -0.073221 };
	std::vector<double> v7 = {0.073221, 0.039949+actualRectSideSize/2, -0.052362};
    
    std::vector<double> v8 = { -0.040319, 0.064036+actualRectSideSize/2, -0.061178 };
	std::vector<double> v9 = { -0.061178 , 0.064036+actualRectSideSize/2, -0.040319 };
	std::vector<double> v10 = { -0.073221, 0.039949+actualRectSideSize/2, -0.052362 };
	std::vector<double> v11 = {-0.052362, 0.039949+actualRectSideSize/2, -0.073221 };
    
    std::vector<double> v12 = { -0.061178, 0.064036+actualRectSideSize/2, 0.040319 };
	std::vector<double> v13 = { -0.040319, 0.064036+actualRectSideSize/2, 0.061178 };
	std::vector<double> v14 = { -0.052362, 0.039949+actualRectSideSize/2, 0.073221};
	std::vector<double> v15 = { -0.073221, 0.039949+actualRectSideSize/2, 0.052362};
    
//     MarkerRhombiGeometries.push_back(v0);
// 	MarkerRhombiGeometries.push_back(v1);
//     MarkerRhombiGeometries.push_back(v2);
//     MarkerRhombiGeometries.push_back(v3);
//     MarkerRhombiGeometries.push_back(v4);
//     MarkerRhombiGeometries.push_back(v5);
//     MarkerRhombiGeometries.push_back(v6);
//     MarkerRhombiGeometries.push_back(v7);
//     MarkerRhombiGeometries.push_back(v8);
//     MarkerRhombiGeometries.push_back(v9);
//     MarkerRhombiGeometries.push_back(v10);
//     MarkerRhombiGeometries.push_back(v11);
//     MarkerRhombiGeometries.push_back(v12);
//     MarkerRhombiGeometries.push_back(v13);
//     MarkerRhombiGeometries.push_back(v14);
//     MarkerRhombiGeometries.push_back(v15);
